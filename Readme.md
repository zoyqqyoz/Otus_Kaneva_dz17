...
1. Пишем [Vagrantfile](https://github.com/zoyqqyoz/Otus_Kaneva_dz17/blob/master/Vagrantfile), в котором создаются 2 ВМ на Centos 7: backup и client, в ВМ backup дополнительно добавляется диск на 2 Гб для хранения резервных копий.
